...
public class Admin extends Account {
	 ...
	 * @param lasName last name of the Admin
	 * @param username username of the Admin
	 * @param password password of the Admin
	 * @param userType type of account ('a')
	 * @param userStatus whether account is active or inactive
	 */
	public Admin(String firstName, String lastName, String username, String password, String userType, String userStatus) {
