...
public class StudentInteractionTest {
	...
	// ArrayList<University> list = student.takeQuiz(location, characteristic,
	// control, emphasis);
	...
	// String control = "-1";
	// ArrayList<University> result = student.fieldSearch(schoolName, state,
	// location, numStudentsMin, numStudentsMax, percentFemaleMin
	// , percentFemaleMax, SATVerbalMin, SATVerbalMax, SATMathMin, SATMathMax,
	// expensesMin, expensesMax
	// , PercentFinancialAidMin, percenetFinancialAidMax, numberApplicantsMin,
	// numberApplicatnsMax
	// , percentAddmittedMin, percentAdmittedMax, percentEnrolledMin,
	// percentEnrolledMax, academicScaleMin
	// , academicScaleMax, socialScaleMin, socialScaleMax, qualityOfLifeMin,
	// qualityOfLifeMax, emphases
	// , control);
	//
	...
	// }
	// assertEquals("Additional recommended schools are "+result, expResults,
	// result);
	// }
	//
	// //good
	...
	// ArrayList<UserSavedSchool> result =
	// dbCon.getSchoolList2(dbCon.getAccount("kmendel001@csbsju.edu"));
	...
	// Account expResult = new Account("No", "Schools", "user@csbsju.edu", "user",
	// "u", "Y");
